{include file="header.tpl"}
    <div class="col">
        <div class="card text-white bg-dark mb-3" style="max-width: 100rem;">
            <div class="card-header">Ingresar los nuevos datos de la id_editorial</div>
            
            <form class="bg-danger p-3 w-100" method="POST" action="edit_editorial/{$editorial->id_editorial}">
